...
class CollegeManagement extends User {
    ...
    private final Menu menu;// Reference to Feedback class

    public CollegeManagement(String userID, String name, String email, String password, Feedback feedback, Menu menu) {
